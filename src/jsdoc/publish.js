...
var packadic = require('./packadic-helper');
...
function generate(type, title, docs, filename, resolveLinks) {
    ...
    var html = packadic.template('container.jade', docData);
...
*/
    ...
    // once for all
    view.nav = packadic.buildNav(members, linkto);
