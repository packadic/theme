...
(function(window, moduleName) {
		...
		var _namespace = function(ns) {
			 ...
			 * @param {!Array.<string>} dependencies An array of dependencies (described as their vendor minus "com.greensock." prefix). For example ["TweenLite","plugins.TweenPlugin","core.Animation"]
